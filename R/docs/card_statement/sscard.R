...
ss_card_result = map(list(read_html("~/data/card/downloads/samsungcard_20210122.xls"),
...
dbListTables(con)
dbWriteTable(con, "CARD_DTL", ss_card_result, append = T)
dbDisconnect(con)
