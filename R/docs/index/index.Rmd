...
library(tidyverse)
# show html files
# list.files('/Volumes/PhotoDisk/30_workspace/emflant.github.io')
# list.files('/Volumes/PhotoDisk/30_workspace/sample/docs')
# list.files('/Volumes/PhotoDisk/30_workspace/sample/R/docs')

origin_files = list.files(path = '/Volumes/PhotoDisk/30_workspace/sample/R/docs', recursive = T, full.names = T, pattern = '\\.html$')
file.copy(origin_files, '/Volumes/PhotoDisk/30_workspace/sample/docs', overwrite = T, copy.date = T)
file.copy(origin_files, '/Volumes/PhotoDisk/30_workspace/emflant.github.io', overwrite = T, copy.date = T)
